...
type JobHistoryFormGroupContent = {
  ...
  employId: FormControl<JobHistoryFormRawValue['employId']>;
  startDate: FormControl<JobHistoryFormRawValue['startDate']>;
  endDate: FormControl<JobHistoryFormRawValue['endDate']>;
  jhistDepFk: FormControl<JobHistoryFormRawValue['jhistDepFk']>;
  jhistJob: FormControl<JobHistoryFormRawValue['jhistJob']>;
};
...
export class JobHistoryFormService {
  createJobHistoryFormGroup(jobHistory: JobHistoryFormGroupInput = { id: null }): JobHistoryFormGroup {
    ...
    return new FormGroup<JobHistoryFormGroupContent>({
      ...
      employId: new FormControl(jobHistoryRawValue.employId, {
        validators: [Validators.required],
      }),
      ...
      jhistDepFk: new FormControl(jobHistoryRawValue.jhistDepFk),
      jhistJob: new FormControl(jobHistoryRawValue.jhistJob),
    });
  }
