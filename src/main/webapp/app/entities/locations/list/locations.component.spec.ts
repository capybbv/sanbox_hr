...
describe('Locations Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'locations', component: LocationsComponent }]),
  ...
  describe('trackId', () => {
    it('Should forward to locationsService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getLocationsIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getLocationsIdentifier).toHaveBeenCalledWith(entity);
