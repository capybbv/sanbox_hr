...
/**
 * REST controller for managing {@link org.ssandwih.domain.JobHistory}.
 */
@RestController
...
public class JobHistoryResource {
    ...
    public ResponseEntity<List<JobHistory>> getAllJobHistories(
        ...
        if (eagerload) {
            page = jobHistoryService.findAllWithEagerRelationships(pageable);
        } else {
            page = jobHistoryService.findAll(pageable);
        }
